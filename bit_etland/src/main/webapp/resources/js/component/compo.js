...
/*			+'    <label for="uname"><b>사원번호</b></label>'
		...
		product_post : ()=>{
			...
			+'                <input type="text" class="form-control" id="firstName" placeholder="" value="스마트폰" required=""></br>'
			+'              </div>'
			+'              <div class="col-md-6 mb-3">'
			...
			+'                <label for="cc-expiration">이미지 등록 </br>(파일업로드)</label>'
			+'                <input type="file" class="form-control" id="cc-expiration" placeholder="" required="">'
			+'              </div>'
			+'              <div class="col-md-3 mb-3">'
			+'                <label for="cc-cvv">이미지 등록 </br>(드래그&드랍)</label>'
